...
class PrestamoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.prestamos.index')
            ->with('mensaje', 'Se registro el prestamo del cliente  de manera correcta')
            ->with('icono', 'success');
    }
...
public function contratos($id)
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.prestamos.index')
            ->with('mensaje', 'Se modifico el prestamo del cliente  de manera correcta')
            ->with('icono', 'success');
    }
    ...
    public function destroy($id)
    {
        Prestamo::destroy($id);
        return redirect()->route('admin.prestamos.index')
            ->with('mensaje', 'Se elimino el prestamo del cliente  de manera correcta')
            ->with('icono', 'success');
    }
}
