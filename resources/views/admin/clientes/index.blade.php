                ...
                <table id="example1" class="table table-bordered table-hover table-striped table-sm">
                    <thead>
                        <rt>
                            ...
                            <th style="text-align: center">Gelular</th>
                            <th style="text-align: center">Celular de ref,</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">{{$cliente->genero}}</td>
                            <td style="text-align: center;">{{$cliente->email}}</td>
                            <td style="text-align: center;">{{$cliente->celular}}</td>
                            <td style="text-align: center;">{{$cliente->ref_celular}}</td>
                            ...
                            <td style="text-align: center">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="{{ url('/admin/clientes', $cliente->id) }}" style="border-radius: 4px;" class="btn btn-info btn-sm">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ url('/admin/clientes', $cliente->id) . '/edit' }}" style="border-radius: 4px;" class="btn btn-success btn-sm">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>
                                    <form action="{{ url('/admin/clientes', $cliente->id) }}" method="post" id="miFormulario{{$cliente->id}}" onsubmit="return preguntar(event, {{$cliente->id}});">
                                        @csrf
                                        @method('DELETE')
