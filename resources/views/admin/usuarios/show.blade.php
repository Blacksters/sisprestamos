    ...
    <div class="col-md-4">
        <div class="card card-outline card-success">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        {{-- Aquí alineamos el botón con padding a la izquierda --}}
                        <div class="form-group pl-3">
                            {{-- Si prefieres centrarlo, cambia por: class="form-group text-center" --}}
                            {{-- O alinearlo a la derecha: class="form-group d-flex justify-content-end" --}}
