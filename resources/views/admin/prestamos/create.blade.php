                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-12">
                                        ...
                                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Escriba aquí..." disabled>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="tasa_interes" name="tasa_interes" value="5" class="form-control">
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                ...
                                <input type="number" name="nro_cuotas" id="nro_cuotas" class="form-control" max="14" oninput="if(this.value > 14) this.value = 14;" min="1" required>
                                @error('nro_cuotas')
                                <small style="color: red;">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="date" name="fecha_inicio" id="fecha_prestamo" class="form-control" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}">
