...
<body>
    ...
    <tr>
        ...
        <td width="350px"></td>
        <td style="text-align: center">
            <img src="{{ public_path('storage/'.$configuracion->logo) }}" width="80px" alt="">
        </td>
    </tr>
</table>
<hr>
<p style="text-align: center">
    <b style="font-size: 25pt"><u>Prestamo nro {{ $prestamo->id }}</u></b>
</p>
<hr>
...
<table border="0" class="table table-bordered" cellpadding="3">
    <thead>
        <tr>
            <th style="background-color: #c0c0c0">Nro de cuotas</th>
            <th style="background-color: #c0c0c0">Fecha de pago</th>
            <th style="background-color: #c0c0c0">Monto</th>
            <th style="background-color: #c0c0c0">Estado</th>
        </tr>
    </thead>
    @php
        $contador = 1;
