                        ...
                        <tr>
                            ...
                            <td style="text-align: center">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="{{ url('/admin/pagos', $pago->id) }}" style="border-radius: 4px;" class="btn btn-info btn-sm">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ url('/admin/pagos/comprobantedepago', $pago->id) }}" style="border-radius: 0px 0px, 0px, 0px;" class="btn btn-warning btn-sm">
                                        <i class="fas fa-print"></i>
                                    </a>

                                    <form action="{{ url('/admin/pagos', $pago->id) }}" method="post" id="miFormulario{{$pago->id}}" onsubmit="return preguntar(event, {{$pago->id}});">
                                        @csrf
