...
Route::get('/home', [App\Http\Controllers\AdminController::class, 'index'])->name('admin.index.home')->middleware(middleware: 'auth');
...
Route::delete('/admin/configuraciones/{id}', [App\Http\Controllers\ConfiguracionController::class, 'destroy'])
    ...
    ->middleware(['auth', 'can:admin.configuracion.destroy']);


// Rutas para Roles
Route::get('/admin/roles', [App\Http\Controllers\RoleController::class, 'index'])
    ->name('admin.roles.index')
    ->middleware(['auth', 'can:admin.roles.index']);

Route::get('/admin/roles/create', [App\Http\Controllers\RoleController::class, 'create'])
    ->name('admin.roles.create')
    ->middleware(['auth', 'can:admin.roles.create']);

Route::post('/admin/roles/create', [App\Http\Controllers\RoleController::class, 'store'])
    ->name('admin.roles.store')
    ->middleware(['auth', 'can:admin.roles.store']);

Route::get('/admin/roles/{id}', [App\Http\Controllers\RoleController::class, 'show'])
    ->name('admin.roles.show')
    ->middleware(['auth', 'can:admin.roles.show']);

Route::get('/admin/roles/{id}/asignar', [App\Http\Controllers\RoleController::class, 'asignar_roles'])
    ->name('admin.roles.asignar_roles')
    ->middleware(['auth', 'can:admin.roles.asignar_roles']);

Route::put('/admin/roles/asignar/{id}', [App\Http\Controllers\RoleController::class, 'update_asignar'])
    ->name('admin.roles.update_asignar')
    ->middleware(['auth', 'can:admin.roles.update_asignar']);

Route::get('/admin/roles/{id}/edit', [App\Http\Controllers\RoleController::class, 'edit'])
    ->name('admin.roles.edit')
    ->middleware(['auth', 'can:admin.roles.edit']);

Route::put('/admin/roles/{id}', [App\Http\Controllers\RoleController::class, 'update'])
    ->name('admin.roles.update')
    ->middleware(['auth', 'can:admin.roles.update']);

Route::delete('/admin/roles/{id}', [App\Http\Controllers\RoleController::class, 'destroy'])
    ->name('admin.roles.destroy')
    ->middleware(['auth', 'can:admin.roles.destroy']);
...
Route::get('/admin/prestamos/cliente/{id}', [App\Http\Controllers\PrestamoController::class, 'obtenerCliente'])
    ...
    ->middleware(['auth', 'can:admin.prestamos.cliente.obtenerCliente']);

Route::post('/admin/prestamos/create', [App\Http\Controllers\PrestamoController::class, 'store'])
    ->name('admin.prestamos.store')
    ->middleware(['auth', 'can:admin.prestamos.store']);

Route::get('/admin/prestamos/{id}', [App\Http\Controllers\PrestamoController::class, 'show'])
    ->name('admin.prestamos.show')
    ->middleware(['auth', 'can:admin.prestamos.show']);

Route::get('/admin/prestamos/contratos/{id}', [App\Http\Controllers\PrestamoController::class, 'contratos'])
    ->name('admin.prestamos.contratos')
    ->middleware(['auth', 'can:admin.prestamos.contratos']);

Route::get('/admin/prestamos/{id}/edit', [App\Http\Controllers\PrestamoController::class, 'edit'])
    ->name('admin.prestamos.edit')
    ->middleware(['auth', 'can:admin.prestamos.edit']);

Route::put('/admin/prestamos/{id}', [App\Http\Controllers\PrestamoController::class, 'update'])
    ->name('admin.prestamos.update')
    ->middleware(['auth', 'can:admin.prestamos.update']);

Route::delete('/admin/prestamos/{id}', [App\Http\Controllers\PrestamoController::class, 'destroy'])
    ->name('admin.prestamos.destroy')
    ->middleware(['auth', 'can:admin.prestamos.destroy']);

// Rutas para Pagos
Route::get('/admin/pagos', [App\Http\Controllers\PagoController::class, 'index'])
    ->name('admin.pagos.index')
    ->middleware(['auth', 'can:admin.pagos.index']);

Route::get('/admin/pagos/prestamos/cliente/{id}', [App\Http\Controllers\PagoController::class, 'cargar_prestamos_cliente'])
    ->name('admin.pagos.cargar_prestamos_cliente')
    ->middleware(['auth', 'can:admin.pagos.cargar_prestamos_cliente']);

Route::get('/admin/pagos/prestamos/create/{id}', [App\Http\Controllers\PagoController::class, 'create'])
    ->name('admin.pagos.create')
    ->middleware(['auth', 'can:admin.pagos.create']);

Route::post('/admin/pagos/create/{id}', [App\Http\Controllers\PagoController::class, 'store'])
    ->name('admin.pagos.store')
    ->middleware(['auth', 'can:admin.pagos.store']);

Route::get('/admin/pagos/comprobantedepago/{id}', [App\Http\Controllers\PagoController::class, 'comprobantedepago'])
    ->name('admin.pagos.comprobantedepago')
    ->middleware(['auth', 'can:admin.pagos.comprobantedepago']);

Route::get('/admin/pagos/{id}', [App\Http\Controllers\PagoController::class, 'show'])
    ->name('admin.pagos.show')
    ->middleware(['auth', 'can:admin.pagos.show']);

Route::post('/admin/pagos/{id}', [App\Http\Controllers\PagoController::class, 'destroy'])
    ->name('admin.pagos.destroy')
    ->middleware(['auth', 'can:admin.pagos.destroy']);
...
Route::get('/admin/notificaciones', [App\Http\Controllers\NotificacionController::class, 'index'])
    ...
    ->middleware(['auth', 'can:admin.notificaciones.index']);

Route::get('/admin/notificaciones/notificar/{id}', [App\Http\Controllers\NotificacionController::class, 'notificar'])
    ->name('admin.notificaciones.notificar')
    ->middleware(['auth', 'can:admin.notificaciones.notificar']);

// Rutas para backup
Route::get('/admin/backups', [App\Http\Controllers\BackupController::class, 'index'])
    ->name('admin.backups.index')
    ->middleware(['auth', 'can:admin.backups.index']);

Route::get('/admin/backups/create', [App\Http\Controllers\BackupController::class, 'create'])
    ->name('admin.backups.create')
    ->middleware(['auth', 'can:admin.backups.create']);

Route::get('/admin/backups/descargar/{nombreARCHIVO}', [App\Http\Controllers\BackupController::class, 'descargar'])
    ->name('admin.backups.descargar')
    ->middleware(['auth', 'can:admin.backups.descargar']);
